  ...
  async onSubmit(){
    ...
    if(this.form.valid && !this.isConfirmPasswordInvalid){
      ...
      const body: any = {
        ...
        confirmPassword: this.form.controls.confirm_password.value!.trim()
      }
      ...
      try{
        ...
        this.toastManagerService.setRedirectToLoginMessage(`Hi, please log in with your updated password`);
